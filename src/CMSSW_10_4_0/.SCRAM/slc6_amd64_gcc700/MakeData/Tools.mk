...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/boost/1.67.0/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/boost/1.67.0/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/boost/1.67.0/include
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cascade/2.2.04-ikaegh/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cgal/4.2-ikaegh/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/charybdis/1.003-ikaegh/include
...
ALL_TOOLS      += cub
cub_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cub/1.8.0-ikaegh/include
cub_EX_USE := cuda
cub_EX_FLAGS_CXXFLAGS  := -DCUB_STDERR

ALL_TOOLS      += cuda-api-wrappers
cuda-api-wrappers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda-api-wrappers/20180504-ikaegh/include
...
cuda-stubs_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda/10.0.130/include
cuda-stubs_EX_LIB := cuda
cuda-stubs_EX_LIBDIR := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda/10.0.130/lib64/stubs
...
ALL_TOOLS      += dablooms
dablooms_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/py2-dablooms/0.9.1-ikaegh/include
...
ALL_TOOLS      += dd4hep
dd4hep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/dd4hep/v01-08x-ikaegh5/include
dd4hep_EX_LIB := DDAlign DDCore DDCond DDParsers
dd4hep_EX_USE := root_cxxdefaults root boost xerces-c clhep

ALL_TOOLS      += dire
dire_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/dire/2.002-ikaegh/include
dire_EX_LIB := dire
...
ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/eigen/c42672350ed4411cf08b593c3394a1061dc07fb4/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/evtgen/1.6.0-ikaegh/include
...
ALL_TOOLS      += gbl
gbl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/gbl/V02-01-03-ikaegh2/include
gbl_EX_LIB := GBL
gbl_EX_USE := eigen
...
ALL_TOOLS      += geneva
geneva_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/geneva/1.0-RC3/include/Geneva
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/hector/1.3.4_patch1-ikaegh3/include
...
ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/heppdt/3.03.00-ikaegh2/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/herwig/6.521-ikaegh/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/herwigpp/7.1.4-ikaegh4/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/jimmy/4.2-ikaegh/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/lhapdf/6.2.1-ikaegh/include
...
libjpeg-turbo_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libjpeg-turbo/2.0.1/include
...
ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libtiff/4.0.3-ikaegh/include
libtiff_EX_LIB := tiff
...
ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libxslt/1.1.28-ikaegh/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/llvm/7.0.0-ikaegh/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/lwtnn/2.4-ikaegh2/include
lwtnn_EX_LIB := lwtnn
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/mctester/1.25.0a-ikaegh3/include
...
py2-pybind11_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/py2-pybind11/2.2.4-ikaegh/include/python2.7
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/pythia8/230-ikaegh/include
...
ALL_TOOLS      += qt
qt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtOpenGL /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := root_cxxdefaults qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-ikaegh/include/Qt3Support
qt3support_EX_LIB := Qt3Support
qt3support_EX_USE := root_cxxdefaults qtbase
qt3support_EX_FLAGS_CPPDEFINES  := -DQT3_SUPPORT

ALL_TOOLS      += qtbase
qtbase_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-ikaegh/include /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-ikaegh/include/Qt /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtCore /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtXml
...
qtdesigner_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-ikaegh/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := root_cxxdefaults qtbase qt

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/rivet/2.5.4-ikaegh4/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/lcg/root/6.12.07-ikaegh3/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/lcg/root/6.12.07-ikaegh3/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/lcg/root/6.12.07-ikaegh3/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /uscms/homes/c/cannaert/work/CMSSW_10_4_0/src /uscms/homes/c/cannaert/work/CMSSW_10_4_0/include/slc6_amd64_gcc700/src /uscms/homes/c/cannaert/work/CMSSW_10_4_0/include/LCG /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_4_0/src /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_4_0/include/slc6_amd64_gcc700/src /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_4_0/include/LCG
self_EX_LIBDIR := /uscms/homes/c/cannaert/work/CMSSW_10_4_0/lib/slc6_amd64_gcc700 /uscms/homes/c/cannaert/work/CMSSW_10_4_0/external/slc6_amd64_gcc700/lib /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_4_0/lib/slc6_amd64_gcc700 /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_4_0/external/slc6_amd64_gcc700/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/sherpa/2.2.5-ikaegh4/include/SHERPA-MC
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tauolapp/1.1.5-ikaegh/include
...
tensorflow_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tensorflow/1.6.0-ikaegh3/include

ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/thepeg/2.1.4-ikaegh4/include
...
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tkonlinesw/4.2.0-1_gcc7-ikaegh3/include
...
ALL_TOOLS      += utm
utm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/utm/utm_0.7.1-ikaegh/include
...
ALL_TOOLS      += vincia
vincia_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/vincia/2.2.01-ikaegh/include
...
ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/yaml-cpp/0.6.2-ikaegh/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/yoda/1.6.7-ikaegh4/include
yoda_EX_LIB := YODA
