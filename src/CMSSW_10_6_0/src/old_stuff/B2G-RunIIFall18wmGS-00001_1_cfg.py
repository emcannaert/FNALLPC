...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:PPD-RunIISummer19UL17pLHE-00001.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ThirteenTeV/Hadronizer_TuneCP5_13TeV_generic_LHE_pythia8_cff.py nevts:50'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:B2G-RunIIFall18wmGS-00001_new.root'),
