...
analyzersanalyzers_INIT_FUNC        += $$(eval $$(call Library,analyzersanalyzers,src/analyzers/analyzers/src,src_analyzers_analyzers_src,$(SCRAMSTORENAME_BIN),,$(SCRAMSTORENAME_LIB),$(SCRAMSTORENAME_LOGS),edm))
endif
