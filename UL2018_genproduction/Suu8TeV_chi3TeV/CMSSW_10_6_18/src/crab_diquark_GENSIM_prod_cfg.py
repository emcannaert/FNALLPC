...
config.General.requestName = 'MC_prod_chi3TeV_Suu8TeV_GENSIM_0001'
...
config.JobType.inputFiles = ['Suu8TeV_chi3TeV.lhe']
...
config.Data.outputDatasetTag = 'SuuToChiChi_MSuu-8TeV_Mchi-3TeV_TuneCP5_13TeV-pythia8'
