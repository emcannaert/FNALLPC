...
config.General.requestName = 'MC_prod_chi850GeV_Suu5TeV_GENSIM_0001'
...
config.JobType.inputFiles = ['Suu5TeV_chi850GeV.lhe']
...
config.Data.outputDatasetTag = 'B2G-RunIISummer20UL18p_Suu5TeV_chi850GeV_GENSIM'
