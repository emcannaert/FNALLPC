...
config.General.requestName = 'MC_prod_Suu6TeV_chi1TeV_GENSIM_0001'
...
config.JobType.inputFiles = ['Suu6TeV_chi1TeV.lhe']
config.Data.outputPrimaryDataset = 'SuuToChiChi_MSuu-6TeV_Mchi-1TeV_TuneCP5_13TeV-pythia8'
