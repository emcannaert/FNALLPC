...
config.General.requestName = 'MC_prod_chi500GeV_Suu4TeV_ALLDECAY_GENSIM_0001'
...
config.Data.outputDatasetTag = 'SuuToChiChi_ALLDECAY_MSuu-4TeV_Mchi-500GeV_TuneCP5_13TeV-pythia8'
