...
config.General.requestName = 'MC_prod_chi2TeV_Suu5TeV_ALLDECAY_GENSIM_0001'
...
config.Data.outputDatasetTag = 'SuuToChiChi_ALLDECAY_MSuu-5TeV_Mchi-2TeV_TuneCP5_13TeV-pythia8'
