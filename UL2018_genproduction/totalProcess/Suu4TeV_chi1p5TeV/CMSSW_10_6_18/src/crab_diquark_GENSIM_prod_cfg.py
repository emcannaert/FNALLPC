...
config.General.requestName = 'MC_prod_chi4TeV_Suu1p5TeV_ALLDECAY_GENSIM_0001'
...
config.Data.outputDatasetTag = 'SuuToChiChi_ALLDECAY_MSuu-4TeV_Mchi-1p5TeV_TuneCP5_13TeV-pythia8'
