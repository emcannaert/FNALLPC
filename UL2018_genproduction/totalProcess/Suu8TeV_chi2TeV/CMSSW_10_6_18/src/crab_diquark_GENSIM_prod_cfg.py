...
config.General.requestName = 'MC_prod_chi2TeV_Suu8TeV_ALLDECAY_GENSIM_0001'
...
config.Data.outputDatasetTag = 'SuuToChiChi_ALLDECAY_MSuu-8TeV_Mchi-2TeV_TuneCP5_13TeV-pythia8'
