...
config.General.requestName = 'MC_prod_chi1p5TeV_Suu6TeV_ALLDECAY_GENSIM_0001'
...
config.Data.outputDatasetTag = 'SuuToChiChi_ALLDECAY_MSuu-6TeV_Mchi-1p5TeV_TuneCP5_13TeV-pythia8'
