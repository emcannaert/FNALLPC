...
config.General.requestName = 'MC_prod_chi1TeV_Suu7TeV_ALLDECAY_GENSIM_0001'
...
config.Data.outputDatasetTag = 'SuuToChiChi_ALLDECAY_MSuu-7TeV_Mchi-1TeV_TuneCP5_13TeV-pythia8'
